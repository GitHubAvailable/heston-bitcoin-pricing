...
class FastCalibrationComparison:
    ...
    def plot_volatility_matching(self, option_data, S0,
                                 save_path='plots/volatility_matching_unclean.png'):
        """
...
def main():
    ...
    results_df.to_csv('results/calibration_comparison_unclean.csv', index=False)
    print("✓ Saved to: results/calibration_comparison_unclean.csv")
